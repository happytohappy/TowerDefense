...
public partial class TableManager
{
    ...
    {
        TextAsset TextFile = Resources.Load<TextAsset>("Table/Buff_Info");
    ...
    public void SetBuffInfoData(string in_sheet_data)
    {
        // 클래스에 있는 변수들을 순서대로 저장한 배열
        FieldInfo[] fields = typeof(BuffInfoData).GetFields(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance);
        ...
        for (int row = 0; row < rows.Length; row++)
        {
            ...
            BuffInfoData tableData = new BuffInfoData();
            ...
            m_dic_buff_info_data.Add(tableData.m_kind, tableData);
        }
    }
}