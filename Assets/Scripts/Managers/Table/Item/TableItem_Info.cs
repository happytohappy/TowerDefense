...
public partial class TableManager
{
    ...
    public void SetItemInfoData(string in_sheet_data)
    {
        // 클래스에 있는 변수들을 순서대로 저장한 배열
        FieldInfo[] fields = typeof(ItemInfoData).GetFields(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance);
        ...
        for (int row = 0; row < rows.Length; row++)
        {
            ...
            ItemInfoData tableData = new ItemInfoData();
            ...
            if (m_dic_item_info_data.ContainsKey(tableData.m_kind))
                m_dic_item_info_data[tableData.m_kind] = tableData;
            else
                m_dic_item_info_data.Add(tableData.m_kind, tableData);
        }
    }
}