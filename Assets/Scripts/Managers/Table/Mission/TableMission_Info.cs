...
public partial class TableManager
{
    ...
    public void SetMissionInfoData(string in_sheet_data)
    {
        // 클래스에 있는 변수들을 순서대로 저장한 배열
        FieldInfo[] fields = typeof(MissionInfoData).GetFields(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance);
        ...
        for (int row = 0; row < rows.Length; row++)
        {
            ...
            MissionInfoData tableData = new MissionInfoData();
            ...
            m_dic_mission_info_data.Add(tableData.m_kind, tableData);
        }
    }
}